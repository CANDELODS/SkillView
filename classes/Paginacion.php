...
class Paginacion{
    ...
    public function numerosPagina(){
        ...
        for($i = 1; $i<= $this->totalPaginas(); $i++){
            ...
            //En lugaar de un enlace agregamos un span con los mismo estilos
            //Esto para que no se pueda hacer click
            if($i === $this->pagina_actual){
                $html .= "<span class=\"paginacion__enlace paginacion__enlace--actual\">{$i}</span>";
            }
            //De lo contrario generamos los enlaces
            //con el número de páginas restantes
            else{
